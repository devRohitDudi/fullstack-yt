...
const BottomBar = () => {
  ...
  //   useEffect(() => {
  //     const pathSegment = pathname.split("/")[1]; // adjust index based on URL
      ...
      <div className="flex flex-col items-center text-xs">
        <Link to="/trending">
          <svg
            ...
            viewBox="0 -960 960 960"
            width="24px"
            fill={`${pathname === "/trending" ? "#4B87D1" : "#e3e3e3"}`}
          >
      ...
      <div className="flex flex-col items-center text-xs">
        ...
        >
          <svg
            ...
            viewBox="0 -960 960 960"
            width="24px"
            fill={`${isPopupOpen ? "#4B87D1" : "#e3e3e3"}`}
          >
      ...
      <div className="flex flex-col items-center text-xs">
        <Link to="/subscription">
          <svg
            ...
            viewBox="0 -960 960 960"
            width="24px"
            fill={`${pathname === "/subscription" ? "#4B87D1" : "#e3e3e3"}`}
          >
      ...
      <div className="flex flex-col items-center text-xs">
        <Link to="/library">
          <svg
            ...
            viewBox="0 -960 960 960"
            width="24px"
            fill={`${pathname === "/library" ? "#4B87D1" : "#e3e3e3"}`}
          >
